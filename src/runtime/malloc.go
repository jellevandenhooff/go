...
const (
	...
	heapAddrBits = goarch.IsWasmFamily*32 + (1-goarch.IsWasmFamily)*((_64bit*(1-goos.IsIos*goarch.IsArm64))*48+(1-_64bit)*(32-(goarch.IsMips+goarch.IsMipsle))+40*goos.IsIos*goarch.IsArm64)
	...
	logHeapArenaBytes = goarch.IsWasmFamily*(9+10) + (1-goarch.IsWasmFamily)*((6+20)*(_64bit*(1-goos.IsWindows)*(1-goos.IsIos*goarch.IsArm64))+(2+20)*(_64bit*goos.IsWindows)+(2+20)*(1-_64bit)+(2+20)*goos.IsIos*goarch.IsArm64)
